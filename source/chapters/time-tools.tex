...
>>> show(timespan)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-b3100d76b8bc4fc2ef1499476cceb8d8.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
\begin{singlespacing}
\vspace{-0.5\baselineskip}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-d712865a7ac4a0c98b9d2d973a74ed16.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-4726f4417b378162039d889693b6263e.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-9f09435a2f810254b54714279c7e9647.pdf}
\begin{lstlisting}
>>> timespan_inventory.all_are_contiguous
False
\end{lstlisting}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-a1baed7bfeed978bb65500b80aa5dfaa.pdf}
\begin{lstlisting}
>>> timespan_inventory.all_are_contiguous
True
\end{lstlisting}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-e4ac71f562009c05e193ba9dae85efdd.pdf}
\begin{lstlisting}
>>> timespan_operand = timespantools.Timespan(6, 10)
>>> result = timespan_inventory & timespan_operand
>>> show(result, range_=(-2, 16))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-4ec264f65bc996c864a9b48ac5cbe14c.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-5d9d796f54f891599cc7acc9617fba2c.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-bc05b18dd221846a1b5430dc627a3267.pdf}
\begin{lstlisting}
>>> left, right = timespan_inventory.split_at_offset(4)
>>> show(left, range_=(0, 10))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2c04274609f97953ec8bbd89aadfc413.pdf}
\begin{lstlisting}
>>> show(right, range_=(0, 10))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-5c670f59eefed207b68b3aa367cfa353.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
...
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-8cdbcbe275ccdcc3038766c9b4580673.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-03b59921ab73c58e2c661e7d3364e624.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-c4d0f7c242913d0a80560789c3b0ab4e.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-918651bb6ef95a5e53cf69fa8f3ecd15.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-402948e94dba6dbc434d48c8145c57dd.pdf}
\begin{lstlisting}
>>> result = timespan_inventory.compute_logical_or()
>>> print(format(result))
timespantools.TimespanInventory(
...
>>> show(result)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-93d6426a2cc8f4fb4a4e5be559f6d05f.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-9f1143a1ffcd1066c5d9e2e28e6eec92.pdf}
\begin{lstlisting}
>>> result = timespan_inventory.compute_logical_and()
>>> print(format(result))
timespantools.TimespanInventory(
...
>>> show(result, range_=(-2, 12))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-f664c6f8f12bfd71ac9b5f6dbbc33904.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, range_=(-2, 12))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-c4bced359d52fc228d82504dad1f5ba4.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-b48506e273798d2fea2e8fdba0378814.pdf}
\begin{lstlisting}
>>> for shard in timespan_inventory.partition():
...     show(shard, range_=(0, 30))
...
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-492c078aaef1fd59600c5b1c38737642.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-02aeb9051437a5d2a90b85d427030ed4.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-30e5e94c6e957e6b83641b120220f02f.pdf}
\begin{lstlisting}
>>> for shard in timespan_inventory.partition(include_tangent_timespans=True):
...     show(shard, range_=(0, 30))
...
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2f62a1453c221a34cf8649282bfca6e4.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-30e5e94c6e957e6b83641b120220f02f.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-4294c9b16654e79dd8b4196742239392.pdf}
\begin{lstlisting}
>>> for shard in timespan_inventory.explode():
...     show(shard, range_=(-2, 20))
...
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-5ec748d0f728293a5d459c82959f17cd.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-e464b429ad2c464ebaf94adafd95ce9e.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-3c6ced1ab399cfbd8ebd12a5d8934d08.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-a93476ed8c64a7ed353f12f43db9c57a.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-4523a9f494a81dc3d4387bf083e19831.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
...
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-306b8e3d24f2f5ce8c75821376795e02.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-e58a3df0e9d7412a2346fc397b0c2faf.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-8d77957c263afcb4a70dfe949721f0a6.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-10785f5970f03e0205cf91e8bc6588f9.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-e3a5069d5b0fc9031f547b54b6f20a01.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-27e6b389700486cdb1e690211f305a4d.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-346d071708fc664289b03a4721497687.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-7b944fcc153075761901edd8195b3e32.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-548f4c0d948374607cff746816857f79.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-36f23e7a3d2536cbc36a14785b3da892.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-a6824fe0661fa2047882450244bd78e4.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond
pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(measure)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-90f242a2ec34e7c5c515c6b3c40a8303.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(measure)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-6488b259469286278b03a4f619cfca2c.pdf}
\begin{lstlisting}
>>> mutate(measure).rewrite_meter(
...     measure,
...     boundary_depth=1,
...
>>> show(measure)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-008efee4241bfb25e55ebf2dd32107ff.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-4806a909d475b76770f30034849c953e.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-ae7b75d383e700d9e1beb062e7aa3e19.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-7530efcfc986c51e9c8cbef83112c665.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(piano_staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-f2d459a62659e0e3f88c3214c38491e2.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(piano_staff_counter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-482b6aa2c1b1bb8069e1a07eb951f493.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_counter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-b38f797d3add77f7983c4d47f9a5a019.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(offset_counter, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2a1bd633d6cdf8ea4218da26fe9117bd.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(permitted_meters, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-97cb93e1b08bcf0647a488b20219cc10.pdf}
\begin{lstlisting}
>>> fitted_meters = metertools.Meter.fit_meters_to_expr(
...     expr=offset_counter,
...     meters=permitted_meters,
...
>>> show(fitted_meters, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-4302134ea59ac747c9a01663c295b965.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(offset_counter, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-562bfc1e85d4abe82375f94a38565772.pdf}
\begin{lstlisting}
>>> show(fitted_meters, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-1e906f7720350ba0f7ef4c3963867450.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(fitted_meters, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-69473953e224f3d721debebdcaba043f.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(offset_counter, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-e2236dbc6731dd2e7d1cbfca9552ed23.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-a0399ccb142fa40b5b23a853584153d0.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-0fd569018c97498b4329402b38ae94da.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-f9b39832a0e1bbda098663f5f968ab26.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-1df98296fbefb2badd1fb802e3010f9c.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(poorly_fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-350c7283ff14d8bef6a1b67c1b437cfc.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
\begin{comment}
<abjadextract time_tools:build_score />[strip_prompt]
\end{comment}
...
\begin{comment}
<abjadextract time_tools:get_meters_and_meter_boundaries />[strip_prompt]
\end{comment}
...
\begin{comment}
<abjadextract time_tools:get_all_voicewise_timespans />[strip_prompt]
\end{comment}
...
\begin{comment}
<abjadextract time_tools:make_performed_music />[strip_prompt]
\end{comment}
...
\begin{comment}
<abjadextract time_tools:make_silent_music />[strip_prompt]
\end{comment}
...
\begin{comment}
<abjadextract time_tools:make_music />[strip_prompt]
\end{comment}
...
\begin{comment}
<abjadextract time_tools:rewrite_meters />[strip_prompt]
\end{comment}
...
\begin{comment}
<abjadextract time_tools:add_time_signature_context />[strip_prompt]
\end{comment}
...
>>> show(performed_rhythm_maker, divisions=divisions)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-6226facd5b3ebd1b93b81442a7bff319.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,page=1]{assets/lilypond-4f155651f325bf7f7eafb4883aa30302.pdf}
\newline
\newline
\noindent\includegraphics[max width=\textwidth,page=2]{assets/lilypond-4f155651f325bf7f7eafb4883aa30302.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory, key='voice_name')
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-18aa5095c4d2a40e30ad09eafabb3032.pdf}
\begin{lstlisting}
>>> score = build_score(
...     performed_rhythm_maker=performed_rhythm_maker,
...     permitted_meters=permitted_meters,
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,page=1]{assets/lilypond-598efa22bd525b6d023acdeda6043e93.pdf}
\newline
\newline
\noindent\includegraphics[max width=\textwidth,page=2]{assets/lilypond-598efa22bd525b6d023acdeda6043e93.pdf}
\newline
\newline
\noindent\includegraphics[max width=\textwidth,page=3]{assets/lilypond-598efa22bd525b6d023acdeda6043e93.pdf}
\end{singlespacing}
\end{abjadbookoutput}
